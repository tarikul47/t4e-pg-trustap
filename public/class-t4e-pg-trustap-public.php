		...
		if ($trustap_user_id) {
			...
			$vendor_billing_fields += array(
				$gateway_slug . '_connection' => array(
					...
					'value' => '<p>You have connected successfully!</p><a href="' . esc_url($disconnect_url) . '" class="button">Disconnect</a></p><p>Please completed your profile before withdrwa your earnings - <a target="_blank" href="' . $trustap_profile_link . '">Click Here</a>',
